...
export default function AdminDashboard({ stats, recentOrders, topProducts, recentUsers }) {
  return (
    <div className="p-8 bg-white min-h-screen">
      <h1 className="text-3xl font-extrabold mb-8 text-black">Admin Dashboard</h1>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div>
          ...
          <ul>
            {recentOrders.map(order => (
              <li key={order.id} className="mb-2 flex justify-between items-center bg-white p-3 rounded-lg border border-gray-200">
        ...
        <div>
          <h2 className="text-xl font-bold mb-4 text-black">Top Products (Likes)</h2>
          <ul>
            {topProducts.map(product => (
              <li key={product.id} className="mb-2 flex justify-between items-center bg-white p-3 rounded-lg border border-gray-200">
  ...
  <div className="bg-white rounded-xl p-6 flex flex-col items-center border border-gray-200">
  ...
  <div className="bg-white rounded-xl p-6 flex flex-col items-center border border-gray-200">
      ...
      <div>
        <h2 className="text-xl font-bold mb-4 text-black">Recent Users</h2>
  <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {recentUsers.map(user => (
            <li key={user.id} className="bg-white rounded-xl p-4 flex flex-col items-center border border-gray-200">
