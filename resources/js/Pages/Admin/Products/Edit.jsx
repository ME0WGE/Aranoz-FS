...
export default function Edit({ product, categories, colors, discounts }) {
                                ...
                                <div className="grid grid-cols-4 gap-4">
                                    {product.picture_main && (
                                        <div className="border rounded-lg p-2">
                                            <img src={product.picture_main} alt="Main" className="w-full h-32 object-cover rounded" />
                                            <p className="text-xs text-center mt-1 text-gray-600">Main</p>
                                        </div>
                                    )}
                                    {product.picture_rear && (
                                        <div className="border rounded-lg p-2">
                                            <img src={product.picture_rear} alt="Rear" className="w-full h-32 object-cover rounded" />
                                            <p className="text-xs text-center mt-1 text-gray-600">Rear</p>
                                        </div>
                                    )}
                                    {product.picture_left && (
                                        <div className="border rounded-lg p-2">
                                            <img src={product.picture_left} alt="Left" className="w-full h-32 object-cover rounded" />
                                            <p className="text-xs text-center mt-1 text-gray-600">Left</p>
                                        </div>
                                    )}
                                    {product.picture_right && (
                                        <div className="border rounded-lg p-2">
                                            <img src={product.picture_right} alt="Right" className="w-full h-32 object-cover rounded" />
                                            <p className="text-xs text-center mt-1 text-gray-600">Right</p>
                                        </div>
                                    )}
                                </div>
                            </div>
